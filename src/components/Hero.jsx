...
function Hero() {
  ...
  return (
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#120905]/65 via-[#120905]/10 to-transparent" />

      <div className="absolute left-[10%] top-[28%] h-[360px] w-[360px] rounded-full bg-[#D5B893]/10 blur-[100px]" />
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-8 lg:px-16"
      >
        <div className="max-w-[720px] pt-16">
          {/* INTERACTIVE BADGE */}
            ...
            >
              <motion.span
                className="h-px w-12 bg-[#D5B893]/70"
                initial={{ width: 0 }}
                animate={{ width: 48 }}
                transition={{
                  duration: 0.8,
          ...
          >
            ...
            >
              ...
              <span className="font-syne text-[15px] font-medium tracking-[0.01em]">
                Explore Menu
              </span>
            </motion.a>
