...
function FeaturedMenu() {
  ...
  >
      ...
      <motion.div
        ...
        className="relative z-10 grid h-full w-full grid-cols-1 items-center gap-6 px-6 pt-32 pb-7 lg:grid-cols-[43%_57%] lg:px-16 lg:pt-20"
      >
        {/* LEFT */}
        <div className="relative z-20 text-[#FFF8EF]">
          ...
          <h2 className="max-w-[560px] font-logo text-[42px] leading-[0.9] tracking-[-0.04em] md:text-[64px]">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <span
                          ...
                          style={{ color: isActive ? item.accent : activeItem.accent }}
                        >
                          0{index + 1}
                        </span>
        ...
        <div className="relative isolate flex h-full min-h-[480px] items-center justify-center overflow-hidden">
          <motion.div
            className="absolute z-0 h-[280px] w-[280px] rounded-full border md:h-[390px] md:w-[390px]"
          ...
          <motion.div
            className="absolute z-0 h-[220px] w-[220px] rounded-full blur-3xl md:h-[330px] md:w-[330px]"
          ...
          <AnimatePresence mode="wait">
            <motion.div
              key={activeItem.name}
              className="pointer-events-none absolute top-[14%] z-0 text-center font-logo text-[68px] leading-none text-white/8 md:text-[110px]"
